...
if (bulletWrap) {
  ...
  /* ============================================================
     ADVISOR SECTION — EXPLICIT, ONE-BY-ONE (NO ABSTRACTION)
  ============================================================
  
     INDEX — ADVISER HANDLERS INCLUDED
     --------------------------------
     1. Borrowing Power           → #bp-adviser
     2. Mortgage Finder           → #mf-adviser
     3. Mortgage Refinance        → #mr-adviser
     4. Repayment Calculator     → #repay-adviser
     5. Stamp Duty Calculator    → #sd-adviser
     6. Insurance Protection     → #ip-adviser
     7. Mortgage Affordability	→ #ma-adviser
  
     (All advisers are defined explicitly below.
      No delegation. No merging. No omissions.)
  ============================================================ */
